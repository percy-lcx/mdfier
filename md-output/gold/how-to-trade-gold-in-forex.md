---
title: 9 Steps to Trade Gold (XAUUSD) in Forex: Beginner's Guide
---

# How to Trade Gold (XAUUSD) in Forex

Trading gold as XAUUSD in Forex requires an understanding of how XAUUSD works, a regulated broker, and a funded account. To get from account setup to your first live trade, follow these 9 steps.

Start by understanding what XAUUSD trading is and what drives its price. Choose a regulated trading platform, open a funded account, and locate XAUUSD as your instrument.

From there, identify the best time to trade, build a trading plan, and place your trade in the correct direction.

Once your trade is live, monitor your position and manage your risk until you are ready to close it.
...
Opening a [XAUUSD trading account](gold) involves 4 steps:
...
Or [practice with a free demo account](https://portal.tmgm.com/register?register_type=demo) before trading live.
...
The [best time to trade XAUUSD](gold-trading-hours) is between 13:00 and 17:00 UTC (08:00 to 12:00 EST). This is the overlap between the London and New York trading sessions, where gold trading volume and price volatility are at their highest. This four-hour window produces the tightest spreads and the largest price moves of the trading day, making it the most practical window for executing XAUUSD trades.
...
- Buy (long)You buy XAUUSD if you expect the price of gold to rise against the US dollar.
- Sell (short)You sell XAUUSD if you expect the price of gold to fall against the US dollar.
...
Enter your lot size based on the risk management rules in your trading plan. For example, with 1:10 leverage, a $200 margin controls a $2,000 gold position. The larger your position size, the greater your exposure to price movements in both directions.
...
**2. Adjust your stop-loss** Move your stop-loss in the direction of the trade if the price moves in your favour. This locks in profit and reduces the risk of a winning trade turning into a loss

**3. Watch economic events** Check your economic calendar for scheduled US data releases that can cause sharp XAUUSD price movements. High-impact events such as CPI releases and Federal Reserve decisions can shift gold prices quickly

**4. Avoid overtrading** Do not open additional XAUUSD positions to recover losses from an open trade. Each trade should meet the entry criteria in your trading plan independently
...
XAUUSD is the Forex market symbol for spot gold priced in US dollars. It is the label used to identify and trade the live gold spot rate against the US dollar on the foreign exchange market, quoted as US dollars per troy ounce.

In [Forex trading](what-is-forex-trading), XAUUSD sits alongside major currency pairs such as EURUSD and GBPUSD, following the same order types, margin requirements, and trade execution rules. It is one of the most actively traded instruments in the Forex market, valued for its liquidity and sensitivity to global economic events.

### Why is gold traded as a currency pair in Forex?

Gold is traded as a currency pair in Forex because it is priced globally in US dollars. Since gold has a direct exchange rate with the dollar, Forex platforms quote it the same way they quote one currency against another.

This structure has 3 practical reasons:

**1. Global dollar pricing**
Gold is bought and sold in US dollars across international markets, making the dollar the natural base for quoting its price

**2. Historical classification**
Gold held monetary status for most of the 20th century under the Bretton Woods system, where major currencies were pegged to its value. That relationship established gold as a currency-like asset, a classification that carried into modern Forex markets

**3. Standardised trading infrastructure**
Quoting gold as a currency pair allows brokers to apply the same margin, leverage, and order execution rules used for all other Forex instruments, simplifying access for traders

Trading gold as a currency pair also means its price is directly affected by US dollar strength. When the dollar strengthens, XAUUSD falls. When the dollar weakens, XAUUSD rises. This inverse relationship is a defining characteristic of gold in the Forex market.

### How much is 1 XAUUSD?

1 XAUUSD represents the price of one troy ounce of gold in US dollars. The exact price changes continuously during market hours as gold is bought and sold globally.

The price of XAUUSD is influenced by US dollar strength, interest rates, and global demand for gold. Tracking the [live gold spot price](xauusd) helps you identify where the market is trading relative to recent highs and lows before placing a trade.

### Can I trade XAUUSD with $100?

Yes, you can trade XAUUSD with $100. Many XAUUSD trading platforms set minimum deposit requirements at or below $100, giving you access to the gold market with a small amount of starting capital.

Once your account is funded, leverage allows your $100 deposit to control a XAUUSD position larger than your account balance. For example, with 1:50 leverage, a $100 deposit controls a $5,000 gold position. This means a small amount of capital can generate meaningful exposure to gold price movements.

### Is trading XAUUSD risky?

Yes, trading XAUUSD carries risk. The level of that risk is largely determined by how you manage your position size, leverage, and stop-loss levels.

XAUUSD trading carries 3 main risks:

**1. Price volatility**
Gold prices can move significantly in a short period, particularly during US economic data releases, Federal Reserve decisions, and geopolitical events

**2. Leverage risk**
Leverage amplifies both profits and losses. A small adverse price movement on a leveraged position can result in a loss larger than your deposited margin

**3. Emotional risk**
Gold's reputation as a safe-haven asset can lead traders to hold losing positions longer than their trading plan allows, compounding losses

The level of risk in XAUUSD trading is directly influenced by your position size, leverage ratio, and adherence to your trading plan. Traders who define their stop-loss levels and risk no more than 1% to 2% of their account per trade reduce their exposure to significant losses.
