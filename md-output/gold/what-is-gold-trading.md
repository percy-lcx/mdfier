---
title: Gold Trading Explained: What It Is and How to Start
---

# What is Gold Trading: How It Works & How to Trade It

Gold trading is the practice of speculating on changes in the gold price through financial instruments rather than owning physical gold. Traders buy or sell gold, often via derivatives such as CFDs, futures, or options, with the goal of profiting from price movements in global markets.

Gold trading works by taking a position based on price direction. Traders go long if they expect gold prices to rise and go short if they expect prices to fall. Prices are quoted using the spot gold price, which reflects real-time global supply and demand in the market. Profit or loss is determined by the difference between the entry and exit price.

You can trade gold by choosing a suitable instrument, opening an account with a regulated broker or exchange intermediary, funding your account, and executing trades with defined entry and risk levels. Many retail traders use gold CFDs because they provide direct exposure to the spot price, allow two-way trading, and require lower starting capital compared to exchange-traded contracts.
...
These advantages explain [why gold remains one of the most actively traded commodities](why-is-gold-valuable) in global markets. Its liquidity, macro sensitivity, and role as a store of value all stem from deeper structural factors that define its long-term appeal.
...
Gold prices can move sharply even within days
...
The gold market is open nearly [24 hours a day, five days a week](gold-trading-hours). Gold trading begins on Sunday at 22:00 UTC and closes on Friday at 21:00 UTC, covering the full global trading week. Most gold derivatives trade approximately 23 hours per day with a short daily maintenance break, depending on the platform.

The gold trading schedule is outlined below:

| Market Phase | UTC Time | EST Time |
| --- | --- | --- |
| Weekly Open | Sunday 22:00 UTC | Sunday 17:00 EST |
| Continuous Trading | Sunday 22:00 UTC to Friday 21:00 UTC | Sunday 17:00 EST to Friday 16:00 EST |
| Typical Daily Maintenance Break* | Varies by platform, often around 21:00–22:00 UTC | Varies by platform, often around 16:00–17:00 EST |
| Most Active Exchange Window (US session) | 13:30–22:00 UTC | 08:30–17:00 EST |
| Weekly Close | Friday 21:00 UTC | Friday 16:00 EST |
...
| Instrument | Best for | Minimum capital | Leverage | Short selling |
| --- | --- | --- | --- | --- |
| Gold CFDs | Active traders and scalpers | $100 or more | Yes | Yes |
| Gold futures | Institutional and swing traders | $5,000 or more | Yes | Yes |
| Gold options | Hedgers and directional traders | Medium to high (depends on premium) | Yes | Yes |
...
Gold CFDs allow you to [speculate on the spot gold price](gold) without owning physical bullion. You trade price movements directly, going long if you expect prices to rise or short if you expect them to fall. Gold CFDs are traded on margin, which means you control a larger position with a smaller initial deposit.
...
You [start trading gold](how-to-trade-gold) by opening an account with a regulated broker that offers gold derivatives and following a structured plan. There are 5 steps to begin:
...
### Do gold traders make money?

Yes, it is possible to make money trading gold, but outcomes vary widely based on skill, capital, and risk control. Profit comes from correctly capturing price differences between entry and exit, whether trading long or short.

Income levels differ significantly. According to Traders Union, professional gold traders at large institutions can earn around USD 300,000 per year, with compensation tied to performance and risk exposure. However, this reflects institutional trading roles rather than retail participation.

Consistent results depend on following a [structured gold trading strategy](gold-trading-guide), controlling position size, and using defined stop-loss levels. Gold offers opportunity, but discipline determines outcomes.

### What is the best way to trade gold?

The best way to trade gold for most retail traders is through gold CFDs. Gold CFDs provide direct exposure to the spot gold price, allow two-way trading, and require lower capital compared to exchange-traded contracts.

### How much money do I need to start trading gold?

The amount of money you need to start trading gold depends on the product you choose.

Gold CFDs require the lowest starting capital. Many brokers allow small minimum deposits, sometimes from USD 10 to USD 100. Because CFDs are traded on margin, you only deposit a percentage of the total trade value.

Gold futures require significantly more capital. A standard gold futures contract has a fixed contract size and higher margin requirements, often several thousand US dollars. Traders commonly maintain USD 5,000 or more to manage price fluctuations safely.

Gold options also require margin or premium payments. The capital needed depends on the contract size and strategy, but it is generally higher and more complex than trading CFDs.

In short, gold CFDs offer the lowest capital barrier to entry, while futures and options require larger upfront funding due to standardized contract structures and exchange margin rules.

### What is gold trading at?

Gold’s price is constantly changing as markets react to economic data, interest rate expectations, and investor sentiment.

In recent sessions, gold has been trading in the range of about USD 4,900 to USD 5,200 per ounce on spot and CFD markets. Over the past year, gold prices have climbed more than 70 percent, driven by inflation concerns and global uncertainty, with long-term benchmarks showing a 52-week range extending roughly from USD 2,800 to above USD 5,600 per ounce on futures contracts.

This range highlights how widely gold can move over time, reflecting shifts in supply and demand as well as macroeconomic influences. Check the [live gold price chart](xauusd) for real-time movements.

### Gold trading and gold investing: what is the difference?

The key difference between gold trading and gold investing is time horizon.

Gold trading focuses on short-term price movements. Traders buy and sell gold based on expected price fluctuations, aiming to profit from changes in the gold market. Positions can last minutes, hours, or weeks, and trading takes place over the counter or on exchanges depending on the instrument used.

Gold investing focuses on long-term wealth preservation. Investors [allocate capital to physical gold or gold-related securities](how-to-invest-in-gold) with the intention of holding the asset over an extended period. The goal is long-term appreciation and portfolio diversification rather than capturing short-term price swings.

### How do I choose between trading gold and silver?

The key criterion for choosing between trading gold and silver is relative value, which is commonly measured by the gold-silver ratio.

The gold-silver ratio shows how many ounces of silver are needed to buy one ounce of gold. A high ratio means silver is relatively cheaper compared to gold. A low ratio means silver is relatively more expensive. Traders use the gold-silver ratio to assess which metal may offer stronger relative opportunity.

If the ratio is historically elevated, some traders prefer silver for potential catch-up moves. If the ratio is compressed, some prefer gold for relative strength and stability. Monitoring the [gold-silver ratio](gold-silver-ratio) helps you decide which metal aligns better with your current trading outlook.
